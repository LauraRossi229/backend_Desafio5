...
userRouter.post('/', async (req, res) => {
    ...
    try {
       ...
       res.render('users', { successMessage: 'Usuario registrado con éxito', users: [] }); // Mostrar mensaje de éxito
    } catch (error) {
        res.status(500).render('users', { errorMessage: 'Error en crear usuario', users: [] }); // Mostrar mensaje de error
    }
})
